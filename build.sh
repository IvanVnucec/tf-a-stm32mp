...
TFA_FLAGS="-j8 DEBUG=1 STM32MP_EARLY_CONSOLE=1 STM32MP_USB_PROGRAMMER=1 CROSS_COMPILE=arm-none-eabi- PLAT=stm32mp1 ARCH=aarch32 ARM_ARCH_MAJOR=7 DTB_FILE_NAME=$TFA_DTB.dtb"
